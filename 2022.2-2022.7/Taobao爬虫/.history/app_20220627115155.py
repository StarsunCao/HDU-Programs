...
comment = compileX.findall(driver.find_elements(By.XPATH, r'//div[@class="col col-4"]/p/a'))
sale = compileX.findall(driver.find_elements(By.XPATH, r'//p[@class="deal-cnt"]'))
