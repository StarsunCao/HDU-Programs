...
sales = []
for i in range(0, 2):
    name = driver.find_elements_by_xpath(By.XPATH, '//div[@class="col col-2"]/p/a').text
    # name = driver.find_elements(By.XPATH, r'//*[@id="mainsrp-itemlist"]/div/div/div/div/div[2]/div[2]/p/a/text()')
    price = driver.find_elements(By.XPATH, '//span[@class="price g_price g_price-highlight"]/strong').text
    location = driver.find_elements(By.XPATH, '//div[@class="location"]').text
    comment = driver.find_elements(By.XPATH, '//div[@class="col col-4"]/a').text
    sale = driver.find_elements(By.XPATH, '//p[@class="deal-cnt"]').text
