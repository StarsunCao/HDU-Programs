...
for i in range(0, 2):
    ...
    picture = driver.find_elements(By.XPATH, r'//div[@class="col col-1"]/div/div/div/a/img')
    ...
    for j in range(0,len(name)):
        ...
        pictures.append(picture[j].get_attribute("data-src"))
...
# 创建csv文件
frame = pd.DataFrame({'商品名称':names, '价格':prices, '地区':locations, '销量':sales, '评论数':comments, '商品链接':links, '图片url':pictures})
